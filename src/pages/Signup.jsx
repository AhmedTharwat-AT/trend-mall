  ...
  return (
    <section className="flex h-[calc(100vh-200px)] min-h-[700px] items-center justify-center  lg:px-16">
      <div className="flex h-[600px] animate-slideRight items-center overflow-hidden lg:max-w-[1170px]  ">
        <div className="h-full w-full  border-r-0 lg:w-1/2 lg:rounded-bl-3xl lg:rounded-tl-3xl lg:border-2">
          <SignupForm />
        </div>
        <div className="relative hidden h-full w-1/2 overflow-hidden lg:block lg:rounded-br-3xl lg:rounded-tr-3xl">
          <img
