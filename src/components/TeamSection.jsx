  ...
  return (
    <section className="bg-white pb-28">
      ...
      <div className="container mt-20">
        <div className="grid grid-cols-1 gap-3 sm:px-0  md:grid-cols-2 lg:grid-cols-3 xl:px-10">
    ...
    >
      <div className=" relative w-fit">
        <img
          ...
          src={img}
        />
        <FaFacebookF className="absolute left-1/2 top-16 z-[2] cursor-pointer rounded-full border border-gray-200 bg-indigo-100 p-2 text-5xl text-[#316FF6] shadow-md  transition-all hover:bg-[#316FF6] hover:text-gray-100 hover:shadow-lg group-hover:-left-11 group-hover:top-0 " />
        <FaInstagram className="absolute left-1/2 top-16 z-[2] cursor-pointer rounded-full border border-gray-200 bg-indigo-100 p-2 text-5xl text-[#d62976] shadow-md transition-all delay-100 hover:bg-[#d62976] hover:text-gray-100 hover:shadow-lg  group-hover:-left-16 group-hover:top-1/2 group-hover:-translate-y-1/2" />
        <FaTwitter className="absolute left-1/2 top-16 z-[2] cursor-pointer rounded-full border border-gray-200 bg-indigo-100 p-2 text-5xl text-[#1DA1F2] shadow-md transition-all delay-200 hover:bg-[#1DA1F2] hover:text-gray-100 hover:shadow-lg group-hover:-left-11 group-hover:top-[160px] " />
      </div>
