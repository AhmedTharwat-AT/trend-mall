function HeadingSeprator({ text = "default" }) {
  ...
  return (
    <div className="relative my-6 flex  h-20  items-center justify-center overflow-hidden border-2 border-gray-600 bg-gray-200 outline outline-2 outline-offset-8 outline-gray-600">
