...
function Header() {
  return (
    <header className=" flex h-[calc(100vh-80px)] animate-slideTop items-center justify-center overflow-hidden bg-[url('/src/assets/carousel/img-2.jpg')] bg-cover bg-right-top text-gray-600">
