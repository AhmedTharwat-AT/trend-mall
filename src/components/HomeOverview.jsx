...
function HomeOverview({ children }) {
  ...
  return (
    <div className=" overflow-hidden bg-[linear-gradient(to_right_,#000000aa,#07656c3d),url('./src/assets/grid-1.png')] bg-cover bg-fixed  bg-center bg-no-repeat grayscale-[0.2] ">
